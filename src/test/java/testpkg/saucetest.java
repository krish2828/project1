...
import utilities.Excelutils;
	...
	public class saucetest extends baseclass {
		...
		{
			saucelogin ob = new saucelogin(driver);
			
			String xl = "E:\\sauceproj.xlsx";
			String Sheet = "Sheet1";
			...
			for(int i = 1;i<= rowcount;i++)
			{
				...
				String passwod = Excelutils.getCellValue(xl, Sheet, i,1);
				System.out.println("password = "+passwod);
				ob.setValues(username, passwod);
				ob.loginclick();
			}
			 List<WebElement> li =   driver.findElements(By.xpath("/html/body/div/div/div/div[2]/div/div/div/div/div[2]/div[2]/button"));
				...
				driver.findElement(By.id("first-name")).sendKeys("Krishnendu");
				driver.findElement(By.id("last-name")).sendKeys("R");
				driver.findElement(By.id("postal-code")).sendKeys("683575");
				Thread.sleep(5000);
